const features = [
  ...
  },
  {
    ...
    desc: "On-time submissions build a streak; a late one holds it without growing it. Skip an assignment and the chain breaks. Simple rules that drive consistent behavior.",
  },
  {
